 ...
 */
~function(window,factory){"use strict";window.angular&&factory(angular)}(window,function(angular){"use strict";angular.module("ngAttrs",[]).directive("ngAttrs",function(){return{restrict:"A",link:function(scope,element,attrs){function ngAttrsWatchAction(value){angular.forEach(value,function(value,key){value===!1?element.removeAttr(key):element.attr(key,value===!0?"":value)})}scope.$watch(attrs.ngAttrs,ngAttrsWatchAction,!0)}}})});